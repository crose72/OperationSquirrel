 ...
 * Exported objects
 ********************************************************************************/
extern uint16_t g_mav_veh_command_id;
extern uint8_t g_mav_veh_command_result;
extern uint8_t g_mav_veh_command_progress;
extern int32_t g_mav_veh_command_result_param2;
extern uint8_t g_mav_veh_command_target_system;
extern uint8_t g_mav_veh_command_target_component;

extern uint32_t g_mav_veh_sys_stat_onbrd_cntrl_snsrs_present;
extern uint32_t g_mav_veh_sys_stat_onbrd_cntrl_snsrs_enabled;
extern uint32_t g_mav_veh_sys_stat_onbrd_cntrl_snsrs_health;
extern uint16_t g_mav_veh_sys_stat_load;
extern uint16_t g_mav_veh_sys_stat_voltage_battery;
extern int16_t g_mav_veh_sys_stat_current_battery;
extern uint16_t g_mav_veh_sys_stat_drop_rate_comm;
extern uint16_t g_mav_veh_sys_stat_errors_comm;
extern uint16_t g_mav_veh_sys_stat_errors_count1;
extern uint16_t g_mav_veh_sys_stat_errors_count2;
extern uint16_t g_mav_veh_sys_stat_errors_count3;
extern uint16_t g_mav_veh_sys_stat_errors_count4;
extern int8_t g_mav_veh_sys_stat_battery_remaining;
extern uint32_t g_mav_veh_sys_stat_onbrd_cntrl_snsrs_prsnt_extnd;
extern uint32_t g_mav_veh_sys_stat_onbrd_cntrl_snsrs_enbld_extnd;
...
extern int32_t g_mav_veh_lat;
extern int32_t g_mav_veh_lon;
extern int32_t g_mav_veh_alt;
...
extern int16_t g_mav_veh_imu_xmag;
extern int16_t g_mav_veh_imu_ymag;
extern int16_t g_mav_veh_imu_zmag;

extern float g_mav_veh_q1_target;
extern float g_mav_veh_q2_target;
extern float g_mav_veh_q3_target;
extern float g_mav_veh_q4_target;
extern float g_mav_veh_roll_rate_target;
extern float g_mav_veh_pitch_rate_target;
extern float g_mav_veh_yaw_rate_target;
extern float g_mav_veh_thrust_target;
...
extern uint8_t g_mav_veh_rngfdr_type;
extern uint8_t g_mav_veh_rngfdr_id;
extern uint8_t g_mav_veh_rngfdr_orientation;
extern uint8_t g_mav_veh_rngfdr_covariance;
extern float g_mav_veh_rngfdr_horizontal_fov;
extern float g_mav_veh_rngfdr_vertical_fov;
extern float g_mav_veh_rngfdr_quaternion[4];
extern uint8_t g_mav_veh_rngfdr_signal_quality;

extern float g_mav_veh_flow_comp_m_x;
extern float g_mav_veh_flow_comp_m_y;
extern float g_mav_veh_ground_distance;
extern int16_t g_mav_veh_flow_x;
extern int16_t g_mav_veh_flow_y;
extern uint8_t g_mav_veh_sensor_id;
