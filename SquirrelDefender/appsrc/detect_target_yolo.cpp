...
bool YOLO::init(void)
{
    ...
    YOLOv8::Config config;
    const std::string engine_path = "/workspace/OperationSquirrel/SquirrelDefender/models/yolov8s/yolov8s.engine.NVIDIAGeForceRTX3060LaptopGPU.fp16.batch1.trt8";
    yolov8_detector = new YOLOv8(engine_path, config);
