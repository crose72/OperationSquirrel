...
void get_tracking_params(void)
{
    ...
    target_detection_thresh = target_params.get_float_param("Detection_Params", "Detect_Thresh");

#if defined(BLD_JETSON_B01)

    target_class = target_params.get_int_param("Detection_Params", "Detect_Class_B01");

#elif defined(BLD_JETSON_ORIN_NANO) || defined(BLD_WSL)

    target_class = target_params.get_int_param("Detection_Params", "Detect_Class_Orin");
