...
void DataLogger::log_data(void)
{
    ...
    // System state
    {
        ...
        m.set_app_elapsed_time(g_app_time_s);
        DataLogger::publish("/system/state", m, g_app_epoch_ns);
    }
    ...
    // MAV system / metadata
    {
        ...
        m.set_sys_stat_voltage_battery(static_cast<uint32_t>(g_mav_batt_voltage_mv));
        m.set_sys_stat_current_battery(static_cast<int32_t>(g_mav_batt_current_ma));
        m.set_sys_stat_battery_remaining(static_cast<int32_t>(g_mav_batt_remaining_pct));
        m.set_rel_alt(static_cast<int32_t>(g_mav_gps_alt_rel));
        m.set_veh_type(static_cast<uint32_t>(g_mav_type));
        m.set_autopilot_type(static_cast<uint32_t>(g_mav_autopilot_type));
        m.set_base_mode(static_cast<uint32_t>(g_mav_mode_base));
        m.set_custom_mode(static_cast<uint32_t>(g_mav_mode_custom));
        m.set_state(static_cast<uint32_t>(g_mav_state));
        m.set_mavlink_version(static_cast<uint32_t>(g_mav_version));
        DataLogger::publish("/mav/system", m, g_app_epoch_ns);
    }
    ...
    // MAV kinematics / attitude
    {
        ...
        DataLogger::logTime(m.mutable_t(), g_app_epoch_ns);
        m.set_frame_id(g_cam0_frame_id);
        m.set_gps_vx(static_cast<int32_t>(g_mav_gps_vel_x));
        m.set_gps_vy(static_cast<int32_t>(g_mav_gps_vel_y));
        m.set_gps_vz(static_cast<int32_t>(g_mav_gps_vel_z));
        m.set_gps_hdg(static_cast<uint32_t>(g_mav_gps_heading_deg));
        ...
        DataLogger::publish("/mav/kinematics", m, g_app_epoch_ns);
    }
    ...
    // MAV IMU raw
    {
        ...
        DataLogger::logTime(m.mutable_t(), g_app_epoch_ns);
        m.set_frame_id(g_cam0_frame_id);
        m.set_imu_ax(static_cast<int32_t>(g_mav_imu_accel_x));
        m.set_imu_ay(static_cast<int32_t>(g_mav_imu_accel_y));
        m.set_imu_az(static_cast<int32_t>(g_mav_imu_accel_z));
        m.set_imu_xgyro(static_cast<int32_t>(g_mav_imu_gyro_x));
        m.set_imu_ygyro(static_cast<int32_t>(g_mav_imu_gyro_y));
        m.set_imu_zgyro(static_cast<int32_t>(g_mav_imu_gyro_z));
        DataLogger::publish("/mav/imu", m, g_app_epoch_ns);
    }
    ...
    // Rangefinder
    {
        ...
        DataLogger::logTime(m.mutable_t(), g_app_epoch_ns);
        m.set_frame_id(g_cam0_frame_id);
        m.set_current_distance(static_cast<uint32_t>(g_mav_rng_dist_m));
        m.set_signal_quality(static_cast<uint32_t>(g_mav_rng_quality));
        DataLogger::publish("/mav/rangefinder", m, g_app_epoch_ns);
    }
    ...
    // Optical flow
    {
        ...
        m.set_flow_x(static_cast<int32_t>(g_mav_flow_px_x));
        m.set_flow_y(static_cast<int32_t>(g_mav_flow_px_y));
        m.set_flow_quality(static_cast<uint32_t>(g_mav_flow_quality));
        m.set_flow_rate_x(g_mav_flow_rate_x);
        m.set_flow_rate_y(g_mav_flow_rate_y);
        DataLogger::publish("/mav/flow", m, g_app_epoch_ns);
    }
    ...
    // Detected objects
    {
        ...
        m.mutable_detections()->Reserve(static_cast<int>(g_det_yolo_list.size()));
        ...
        DataLogger::publish("/detection/objects", m, g_app_epoch_ns);
        publish("/camera/annotations", m, g_app_epoch_ns); // schema name must be foxglove.ImageAnnotations
    }
    ...
    // Target detections/tracks
    {
        ...
        m.set_target_detection_conf(g_tgt_conf);
        m.set_target_cntr_offset_x(g_tgt_cntr_offset_x_pix);
        m.set_target_cntr_offset_y(g_tgt_cntr_offset_y_pix);
        m.set_target_cntr_offset_x_filt(g_tgt_cntr_offset_x_filt);
        m.set_target_cntr_offset_y_filt(g_tgt_cntr_offset_y_filt);
        m.set_target_height(g_tgt_height_pix);
        m.set_target_width(g_tgt_width_pix);
        m.set_target_aspect(g_tgt_aspect_ratio);
        m.set_target_left(g_tgt_left_px);
        m.set_target_right(g_tgt_right_px);
        m.set_target_top(g_tgt_top_px);
        m.set_target_bottom(g_tgt_bottom_px);
        DataLogger::publish("/target/detection", m, g_app_epoch_ns);
    }
    ...
    // Target estimate
    {
        ...
        DataLogger::logTime(m.mutable_t(), g_app_epoch_ns);
        m.set_frame_id(g_cam0_frame_id);
        m.set_d_target_h(g_tgt_height_meas);
        m.set_d_target_w(g_tgt_width_meas);
        m.set_x_target(g_tgt_pos_x_meas);
        m.set_y_target(g_tgt_pos_y_meas);
        m.set_z_target(g_tgt_pos_z_meas);
        m.set_d_target(g_tgt_dist_meas);
        m.set_delta_angle(g_cam_delta_angle_deg);
        m.set_camera_tilt_angle(g_cam_tilt_deg);
        m.set_delta_d_x(g_dist_delta_x);
        m.set_delta_d_z(g_dist_delta_z);
        m.set_x_target_ekf(g_tgt_pos_x_est);
        m.set_y_target_ekf(g_tgt_pos_y_est);
        m.set_vx_target_ekf(g_tgt_vel_x_est);
        m.set_vy_target_ekf(g_tgt_vel_y_est);
        m.set_ax_target_ekf(g_tgt_acc_x_est);
        m.set_ay_target_ekf(g_tgt_acc_y_est);
        m.set_target_data_useful(g_tgt_meas_valid);
        DataLogger::publish("/target/location", m, g_app_epoch_ns);
    }
    ...
    // Control adjustments
    {
        ...
        DataLogger::logTime(m.mutable_t(), g_app_epoch_ns);
        m.set_frame_id(g_cam0_frame_id);
        m.set_target_too_close(g_tgt_too_close);
        m.set_x_error(g_pos_err_x);
        m.set_y_error(g_pos_err_y);
        m.set_yaw_error(g_yaw_err);
        m.set_yaw_adjusted_for_playback(g_veh_yaw_playback_adj);
        m.set_yaw_target(g_ctrl_yaw_tgt);
        m.set_vx_adjust(g_ctrl_vel_x_cmd);
        m.set_vy_adjust(g_ctrl_vel_y_cmd);
        m.set_vz_adjust(g_ctrl_vel_z_cmd);
        m.set_yaw_adjust(g_ctrl_yaw_cmd);
        DataLogger::publish("/path/control", m, g_app_epoch_ns);
    }
}
