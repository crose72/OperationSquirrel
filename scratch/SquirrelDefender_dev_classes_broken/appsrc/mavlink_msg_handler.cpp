 ...
 * Description: Tell the autopilot the how frequently to send specific mavlink 
 *              messages.
 ********************************************************************************/
void MavMsg::set_message_rates(void)
{
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_HEARTBEAT, MESSAGE_RATE_DEFAULT);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_SYSTEM_TIME, MESSAGE_RATE_DEFAULT);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_SCALED_IMU, MESSAGE_RATE_DEFAULT);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_ATTITUDE, MESSAGE_RATE_1000us);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_ATTITUDE_TARGET, MESSAGE_RATE_1000us);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_ATTITUDE_QUATERNION, MESSAGE_RATE_1000us);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_GLOBAL_POSITION_INT, MESSAGE_RATE_DEFAULT);
    mav.set_mav_msg_rate(MAV_CMD_SET_MESSAGE_INTERVAL, MAVLINK_MSG_ID_AUTOPILOT_VERSION, MESSAGE_RATE_DEFAULT);
}

/********************************************************************************
 * Function: request_messages
 * Description: Tell the autopilot to begin sending specific messages at a
 *              rate that has already been set.
 ********************************************************************************/
void MavMsg::request_messages(void)
{
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_HEARTBEAT);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_SYSTEM_TIME);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_SCALED_IMU);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_ATTITUDE);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_ATTITUDE_TARGET);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_ATTITUDE_QUATERNION);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_GLOBAL_POSITION_INT);
    mav.req_mav_msg(MAV_CMD_REQUEST_MESSAGE, MAVLINK_MSG_ID_AUTOPILOT_VERSION);
}
 ...
 ********************************************************************************/
void MavMsg::parse_serial_data(void)
{
