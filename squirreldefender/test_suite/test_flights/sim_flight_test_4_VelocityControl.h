...
void test_flight(void)
{
    ...
    if (timerVal > 12.0 && stage == 0)
    {
        ...
        target_velocity[1] = 0;
        target_velocity[2] = 0;
        MavMotion::cmd_velocity_ned(companion_sys_id, companion_comp_id, autopilot_sys_id, autopilot_comp_id, target_velocity, target_velocity[0], target_velocity[1]);
        stage = 1;
    }
    ...
    {
        MavCmd::set_mode_rtl(companion_sys_id, companion_comp_id, autopilot_sys_id, autopilot_comp_id);
    }
}
